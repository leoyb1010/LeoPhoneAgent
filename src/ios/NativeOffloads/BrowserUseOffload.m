...
static NSString *const HELP_TEXT =
    @"minis-browser-use - Drive the in-app WebView from the shell\n"
     ...
     "  get_accessibility_tree [--max-depth <n>]\n"
     "                  Roles, accessible names, states and a usable CSS\n"
     "                  selector for every semantic node. Far cheaper than a\n"
     "                  screenshot; --max-depth caps the node count (20-600).\n"
     "  fetch           --url <url>\n"
     "  new_tab         [--url <url>]\n"
     "  close_tab       [--tab-id <n>]\n"
     "  list_tabs\n"
