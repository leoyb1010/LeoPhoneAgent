...
enum FPSyncTraceLog {
    ...
    private static let queue = DispatchQueue(label: "com.leoyuan.leophoneagent.FileProvider.fpSyncTrace")
    private static let osLog = OSLog(subsystem: "com.leoyuan.leophoneagent.FileProvider", category: "FPSyncTrace")
