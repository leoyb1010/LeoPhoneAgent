    ...
    localHandler: async ({ res }) => {
      ...
      res.end(JSON.stringify({
        error: {
          ...
          message: 'LeoAgent could not resolve the parent Provider route for this spawned Codex agent.',
        },
      }));
    },
  };
      ...
      localHandler: async ({ res }) => {
        ...
        res.end(JSON.stringify({
          error: {
            ...
            message: 'LeoAgent AI credentials are not ready for this bridged model.',
          },
        }));
      },
    };
