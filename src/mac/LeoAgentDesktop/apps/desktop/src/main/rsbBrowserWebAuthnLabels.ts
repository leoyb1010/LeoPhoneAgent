...
> = {
  'zh-CN': {
    ...
    detail: 'LeoAgent 只会把你的选择交给认证器；通行密钥的私密信息始终留在认证器中。',
    cancel: '取消通行密钥登录',
  ...
  en: {
    ...
    detail:
      'LeoAgent only passes your selection to the authenticator; the passkey secret stays in the authenticator.',
  ...
  ja: {
    ...
    detail:
      'LeoAgent は選択内容のみを認証器に渡します。パスキーの秘密情報は常に認証器内に保持されます。',
  ...
  ko: {
    ...
    detail:
      'LeoAgent는 선택 내용만 인증 장치에 전달하며, 패스키의 비밀 정보는 항상 인증 장치에 남아 있습니다.',
    cancel: '패스키 로그인 취소',
