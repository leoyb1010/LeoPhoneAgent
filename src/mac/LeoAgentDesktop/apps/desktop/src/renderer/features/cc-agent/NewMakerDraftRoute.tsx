        ...
        >
          ...
          <main
            ...
            className={cn(
              ...
              // LeoAgent:上游用视口百分比(18vh/28vh)把欢迎区压到窗口中部,
              // 大屏全屏时顶部是接近半屏的空白,读起来像布局坏了。改为固定
              // 顶距,内容靠上,窗口再高也不膨胀。
              isDraftNarrow
                ? 'px-4 pt-[calc(72px_-_var(--content-header-h,46px)_+_46px)]'
                : showProviderOnboardingCard
                  ? 'px-8 pt-[calc(56px_-_var(--content-header-h,46px)_+_46px)]'
                  : 'px-8 pt-[calc(88px_-_var(--content-header-h,46px)_+_46px)]',
            )}
          >
            <div
