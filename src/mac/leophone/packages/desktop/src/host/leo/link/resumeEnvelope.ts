/** First SSE frame for harness events. Mirrors src/harmony/protocol/resumeEnvelope.ts;移植自 leocodebox(src/mac/leocodebox/server/modules/leophone/resume-envelope.ts)。 */
