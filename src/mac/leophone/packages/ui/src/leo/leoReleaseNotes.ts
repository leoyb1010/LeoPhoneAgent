...
export const LEO_RELEASE_NOTES: LeoRelease[] = [
  {
    ...
    date: "2026-09-21",
    items: [
      "Mac 端整体换成 ZCode 内核(zai-org/ZCode 3.14,Apache-2.0)。会话工作台、工具时间线、Git 面板、文件树与搜索、终端、内嵌浏览器与 Browser Use、插件商店、MCP、技能、Hooks、斜杠命令、定时任务与闲时任务、记忆、会话分享与导入、SSH / WSL / Docker 远程工作区,全部可用。",
      "权限四档 plan / build / ask / yolo,按会话切换;模型用 API key 接入 Anthropic、OpenAI、OpenAI 兼容端点与任意自定义供应商,智谱账号是可选项不是前提。",
      "改成我们自己的:品牌、图标、更新源换回 leocodebox-updates;不向 Z.ai 上报遥测、崩溃与性能数据。",
