export type LLMProvider = 'claude' | 'cursor' | 'codex' | 'opencode' | 'grok';
...
export type AppTab = 'dashboard' | 'chat' | 'files' | 'shell' | 'git' | 'tasks' | 'browser' | 'audit' | 'missions' | 'fleet' | 'collections' | `plugin:${string}`;
