...
export default function SidebarContent({
  ...
  return (
    <div
      className="leocodebox-sidebar-content flex h-full flex-col bg-background/80 md:w-[280px] md:select-none"
      style={{}}
    >
      <SidebarHeader
        isPWA={isPWA}
                ...
                return (
                  <div key={project.projectId} className="overflow-hidden rounded-xl border border-border/70 bg-card/60 shadow-elevation-1">
                    <div className="flex items-start justify-between gap-3 border-b border-border/60 px-3 py-2.5">
                      ...
                      <button
                        className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-lg bg-success/15 text-success transition-colors hover:bg-success/25 dark:bg-success/20 dark:text-success dark:hover:bg-success/30"
                  ...
                  <div className="divide-y divide-border/50">
                    {group.sessions.map((session) => (
                      <div key={session.sessionId} className="flex items-center gap-2 px-3 py-2.5">
                        ...
                        <button
                          className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-lg bg-destructive/15 text-destructive transition-colors hover:bg-destructive/25 dark:bg-destructive/20 dark:text-destructive dark:hover:bg-destructive/30"
