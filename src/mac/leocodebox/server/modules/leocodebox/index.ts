...
export { bindFrontmostToSession, clickBoundSessionWindow, exactWindowCapabilities, keyBoundSessionWindow, raiseBoundSessionWindow, typeBoundSessionWindow } from './exact-window-macos.js';
