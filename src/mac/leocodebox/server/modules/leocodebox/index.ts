...
export { bindFrontmostToSession, clickBoundSessionWindow, dragBoundSessionWindow, exactWindowCapabilities, keyBoundSessionWindow, raiseBoundSessionWindow, scrollBoundSessionWindow, typeBoundSessionWindow } from './exact-window-macos.js';
