...
fun EnvironmentVariablesScreen(
    ...
    val privacyEnabled by com.leoyuan.leophoneagent.data.EnvVarPrivacyStore.enabled.collectAsState()
    ...
    SettingsScaffold(
        ...
        SettingsSection(
            ...
            SettingsSwitchRow(
                ...
                onCheckedChange = { com.leoyuan.leophoneagent.data.EnvVarPrivacyStore.setEnabled(it) },
                showDivider = false,
            )
        }
    ...
    if (deleteEntryId != null) {
        ...
        AlertDialog(
            ...
            title = {
                Text(stringResource(R.string.common_delete_named, entry?.key ?: stringResource(R.string.common_variable)))
            },
