...
object DeepLinkHandler {
    fun parse(uri: Uri?): DeepLinkAction {
        if (uri == null || uri.scheme !in SUPPORTED_SCHEMES) return DeepLinkAction.Unknown
    ...
    private val SUPPORTED_SCHEMES = setOf("leophoneagent", "minis")
    ...
    private fun parseSettingsPath(uri: Uri): DeepLinkAction {
        ...
        return when (head) {
            ...
            "system-permissions", "system_permissions", "assistant" ->
