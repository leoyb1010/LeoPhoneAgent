...
import com.leoyuan.leophoneagent.ui.terminal.emulator.TerminalColor
...
fun TerminalCanvasView(
    ...
    val terminalTypeface = com.leoyuan.leophoneagent.ui.terminal.rememberJetBrainsMonoTypeface()
