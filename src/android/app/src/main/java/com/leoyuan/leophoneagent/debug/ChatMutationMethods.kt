...
internal object ChatMutationMethods {
     ...
     * [com.leoyuan.leophoneagent.ui.chat.ChatViewModelStore]) — unlike [prompt], which
    ...
    suspend fun uiPrompt(context: Context, params: JSONObject): JSONObject {
        ...
        val app = app(context)
        val store = com.leoyuan.leophoneagent.ui.chat.ChatViewModelStore
        ...
        val vm = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.Main) {
            androidx.lifecycle.ViewModelProvider(
                ...
                com.leoyuan.leophoneagent.ui.chat.ChatViewModel.factory(
                    sessionId = sessionId,
            ...
            )[com.leoyuan.leophoneagent.ui.chat.ChatViewModel::class.java].also { it.sendMessage(text) }
        }
    ...
    suspend fun status(context: Context, params: JSONObject): JSONObject {
        ...
        return JSONObject().apply {
            ...
            put("isRunning", com.leoyuan.leophoneagent.service.SessionActivityTracker.isActive(sessionId))
